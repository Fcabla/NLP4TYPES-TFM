...
# Extract from a dataframe a set of types that are unique, 1 instance per type of type
...
# Replace the types as text for an index from the unique set of types
